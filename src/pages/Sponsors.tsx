...
const Sponsors = ({}: SponsorsProps) => {
  ...
  return (
    <>
      ...
      <div className="col">
      <h1 className="text-white text-center my-5" style={{fontSize: "50px", fontFamily:'Roboto'}}>Sponsors</h1>
      ...
      Information Technology is growing exponentially constantly, every second, 
        around the globe.India is not far behind with its own IT industry booming 
        to new heights. Get to know about 'Future of IT sector in India' on the 24th
         of October at the Panel Session in Abhiyantriki 2021!
      </div>
    </div>
  </div>

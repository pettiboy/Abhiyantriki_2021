...
const About = ({}: AboutProps) => {
  ...
  <div className="container">
    <div className="d-md-flex justify-content-between align-items-center">
      <img src="assets/logos/about-kjsce.png" alt="" className="kj-img kjsce" />
    ...
    <h1 className="text-center" style={{color: "palegoldenrod"}}>ABOUT</h1>
    <div className="
          d-md-flex
        ...
        ">
      <div>
        <img src="assets/logos/about-abhiyantriki.png" alt="" className="kj-img abhiyantriki" />
      </div>
